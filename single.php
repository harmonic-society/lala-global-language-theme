            ...
            <div class="content-layout">
                ...
                <aside class="sidebar-enhanced">
                    <div class="sidebar-sticky-wrapper">
                        <!-- Tag Cloud Widget -->
                        <div class="sidebar-widget sidebar-tag-cloud">
                            ...
                            <div class="sidebar-posts-list">
                                ...
                                if ( ! empty( $popular_posts ) ) :
                                    ...
                                    foreach ( $popular_posts as $post ) :
                                        setup_postdata( $post );
                                        $views = lala_get_post_views( $post->ID );
                                ?>
                                    <a href="<?php the_permalink(); ?>" class="sidebar-post-item popular-item">
                    ...
                    <div class="article-cta-section">
                        ...
                        <div class="cta-content">
                            ...
                            <p class="cta-description">
                                ネイティブ講師とのマンツーマンレッスンを<br class="pc-only">
                                お気軽にお試しいただけます。
                            </p>
                            ...
                            <div class="cta-button-wrapper">
                                <a href="https://taiken.lala-global-language.com/" class="cta-button" target="_blank" rel="noopener noreferrer">
